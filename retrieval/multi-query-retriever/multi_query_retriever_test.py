...
### Basic-Query-Retriever
retriever_from_llm = RetrievalQA.from_llm(
    retriever=vectordb.as_retriever(
        # 아래와 같은 설정들을 해주지 않아도 기본적으로 여러개의 질문을 만들어서 답변을 받다보니, 좀 더 다양하고 구체적인 답변을 받을 수 있음
        # search_type="mmr",
...
unique_docs = retriever_from_llm(question)
print(len(unique_docs))
print(unique_docs)
""" 프롬프팅 없는 일반 RetrievalQA-Query
{
    'query': '삼성전자 갤럭시 S24는 어떨 예정이야?', 
    'result': '삼성전자 갤럭시 S24는 AI 서비스가 대거 탑재될 것으로 예상되며, 새로운 스마트폰 기준을 제시할 것으로 전망됩니다. 또한, 갤럭시 S24에는 실시간 통화 통역 기능이 포함될 것으로 알려졌습니다.', 
    'source_documents': [
        Document(
...
[
    ...
    Document(
        page_content='기준 오닉스 블랙, 마블 그레이, 코발트 바이올렛, 앰버 옐로우 등 4가지이며 울트라는 티타늄 블랙, 티타늄 그레이, 티타늄 바이올렛, 티타늄 옐로우 등 4가지가 될 것으로 예상된다. 이 밖에 삼성닷컴 판매 한정으로 티타늄 그린, 티타늄 블루, 티타늄 오렌지도 추가될 전망이다.국내 출고가 일반·플러스 동결, 울트라 약 10만원 인상될 듯…19일 사전예약소비자 입장에서 제일 궁금한 건 가격과 사전 예약 혜택이다.일반형, 플러스 모델(256GB 기준) 가격은 전작과 같을 것으로 전망된다. 256GB 용량 기준 일반형과 플러스 모델', 
        metadata={'language': 'ko', 'source': 'https://n.news.naver.com/mnews/article/003/0012317114?sid=105', 'title': "언팩 D-4, 세계 최초 AI폰 '갤S24' 이렇게 나온다"}
    ), 
    Document(
        page_content='예상 출고가는 각각 115만5000원, 135만3000원으로 잠정 책정된 것으로 알려졌다. 512GB의 경우 전작 대비 2만2000원 비싸진 129만8000원, 149만6000원이 될 전망이다.울트라 모델은 전작보다 비싸질 것으로 알려졌다. 256GB는 9만9000원 오른 169만8400원, 512GB는 12만1000원 오른 184만1400원으로 예상된다.사전 예약 기간은 19일부터 25일까지 7일간 진행될 것으로 예상되며 사전 예약 혜택은 더블 스토리지, 갤럭시 워치 할인, 갤럭시 버즈 FE 할인 등이 거론되고 있다.더블',
        metadata={'language': 'ko', 'source': 'https://n.news.naver.com/mnews/article/003/0012317114?sid=105', 'title': "언팩 D-4, 세계 최초 AI폰 '갤S24' 이렇게 나온다"}
    )
]
"""